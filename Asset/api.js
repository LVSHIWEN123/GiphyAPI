var animal = ['dog', "cat", "bee"];
    ...
    function displayAnimalImg() {
        ...
        var queryUrl =
            'https://api.giphy.com/v1/gifs/search?api_key=KAm9GPR66I1KTmZ27OXGP8NIwxAu4Hfm&q=' + searchName +
        ...
        $.ajax({
            ...
            for (let i = 0; i < 10; i++) {
                ...
                $('img').eq(i).attr('src', imgURL).attr('data-animate', imgURL).attr('data-still', imgStill);
